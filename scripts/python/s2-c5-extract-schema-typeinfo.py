...
def main(input_file):
    ...
    # fname_output_preprocess = "slices-new/fb-rdf-pred-type/fb-rdf-pred-type-domain"
    ...
    query_count = 0
    fname_input = "slices-new/fb-rdf-pred-type/fb-rdf-pred-type-domain"
    fname_output = "slices-new/fb-rdf-pred-schema-domains-ids-1-byalpha-typeinfo"
    ...
    # Preserve the triples with the ids, and get additional triples on description
    query_count = 0
    fname_output = "slices-new/fb-rdf-pred-schema-types-ids-1-byalpha-typeinfo"
    ...
    for typ in types:
        ...
        inputs = ["slices-new/fb-rdf-pred-type/fb-rdf-pred-type-type-default_property",
                "slices-new/fb-rdf-pred-type/fb-rdf-pred-type-type-expected_by",
                "slices-new/fb-rdf-pred-type/fb-rdf-pred-type-type-extends",
                "slices-new/fb-rdf-pred-type/fb-rdf-pred-type-type-properties" ]
        for inpt in inputs:
            fname_input = inpt
    ...
    # Preserve the triples with the ids, and get additional triples on description
    query_count = 0
    fname_input = "slices-new/fb-rdf-pred-type/fb-rdf-pred-type-property"
    fname_output = "slices-new/fb-rdf-pred-schema-properties-ids-1-byalpha-typeinfo"
